...
$L['adm_help_config_rss'] = "Ссылки для вызова RSS лент:<br />".$cfg['mainurl']."/"."rss (по-умолчанию, выводятся новости из категории указанной в настройках)<br />".$cfg['mainurl']."/"."rss/pages?c=XX (XX - код категории, последние страницы из категории)<br />".$cfg['mainurl']."/"."rss/comments?id=XX (XX - ID страницы, комментарии к странице)";
